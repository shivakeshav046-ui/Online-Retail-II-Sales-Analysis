# Online Retail Sales Analysis Using Python, Pandas & Matplotlib

## Dataset

* **Dataset Name:** Online Retail II
* **Source:** UCI Machine Learning Repository
* **Total Records:** **1,027,017 rows**
...
This project analyzes the **Online Retail II** dataset using **Python, Pandas, and Matplotlib**. The dataset contains **1,027,017 transactional records** from a UK-based online retail business.
